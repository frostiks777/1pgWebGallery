...
**Проблема:** Было 4 разных API эндпоинта (`/api/photos/[...path]`, `/api/thumbnail`, `/api/medium`, `/api/photo-file`) с дублирующей логикой.

**Решение:**
- Создан единый оптимизированный эндпоинт `/api/images` с параметром `?size=thumbnail|medium|full`
...
- ✅ Единый кэш для всех изображений в `.cache/images/`
